...
#  Default: '/Library/Frameworks/Python.framework/Versions/3.12/share/jupyterhub'
# c.JupyterHub.data_files_path = '/Library/Frameworks/Python.framework/Versions/3.12/share/jupyterhub'
...
#  Default: []
c.Spawner.args = ['--NotebookApp.default_url=~/tutorials/kamil/tutorial.ipynb']
...
#  Default: 'quay.io/jupyterhub/singleuser:5.3'
# c.DockerSpawner.container_image = 'quay.io/jupyterhub/singleuser:5.3'
...
#      Added callable support.
#  Default: traitlets.Undefined
# c.DockerSpawner.extra_host_config = traitlets.Undefined
...
# c.DockerSpawner.notebook_dir = '~/tutorials'
...
# c.SwarmSpawner.container_image = 'quay.io/jupyterhub/singleuser:5.3'
...
# c.SwarmSpawner.image = 'vector-modelling-tutorials'
...
## Deprecated, use ``DockerSpawner.image``.
#  See also: DockerSpawner.container_image
# c.SystemUserSpawner.container_image = 'quay.io/jupyterhub/singleuser:5.3'
...
## The image to use for single-user servers.
#  See also: DockerSpawner.image
# c.SystemUserSpawner.image = 'quay.io/jupyterhub/singleuser:5.3'
...
## List of SSL alt names
#  See also: Spawner.ssl_alt_names
# c.SystemUserSpawner.ssl_alt_names = []
...
## 
#  See also: Authenticator.allow_all
# c.SharedPasswordAuthenticator.allow_all = True
