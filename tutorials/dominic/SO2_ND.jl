...
#Differential equations to be solved
  ...
  dy[numb_A_1:numb_A_2] = R_A              .-  delta_AT(TEMP_NOW )         .* y[numb_A_1:numb_A_2] .-  (human_vector(TEMP_NOW) .* bite(TEMP_NOW)) .* y[numb_A_1:numb_A_2]  .*  (y[numb_H_I]  ./ (y[numb_H_S]   + y[numb_H_I]  + y[numb_H_R] .+ 15000   ))                       ;
  dy[numb_I_1:numb_I_2] =                  .-  delta_AT(TEMP_NOW )         .* y[numb_I_1:numb_I_2] .+  (human_vector(TEMP_NOW) .* bite(TEMP_NOW)) .* y[numb_A_1:numb_A_2]  .*  (y[numb_H_I]  ./ (y[numb_H_S]   + y[numb_H_I]  + y[numb_H_R] .+ 15000   ))  ;
  ...
  dy[numb_H_I]                  = .+ vector_human(Temp(t - 4)) .* bite(Temp(t - 4))   .*  40* 4  .* abs(sum(y[numb_I_1:numb_I_2])) .* y[numb_H_S] ./ (y[numb_H_S] + y[numb_H_I] + y[numb_H_R]  .+ 15000      ) .+ infect(t) .- 
                                    0.25 * y[numb_H_I] 
  dy[numb_H_R]                  = .+ 0.25 * y[numb_H_I]
